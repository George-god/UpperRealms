            ...
            <div class="flex flex-wrap items-center justify-between gap-4">
                <div>
                    ...
                    <p class="text-gray-400 text-sm mt-2">
                        Cycle: <span id="explore-burst-text" class="text-cyan-300 font-medium"><?php echo (int)$exploreBurstUsed; ?> / <?php echo (int)$exploreBurstMax; ?></span> explorations
                        before a 30-minute long rest (same 5-second pacing as cultivation between explores).
                    </p>
                </div>
                <div class="text-sm text-gray-400">
                    ...
                    <?php if ($exploreInLongRest): ?>
                        <span class="block text-xs text-amber-300 mt-1">Long rest active — wait for the timer above.</span>
                    <?php endif; ?>
                </div>
            </div>
        </div>
