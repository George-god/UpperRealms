-- Cultivation RPG — complete database schema (core + bloodlines + caves + artifacts).
-- This is the only bundled full-schema file at repo root. New environment:
--   mysql -u USER -p < database_full.sql
-- Optional / incremental snippets: sql/archive/
...
ALTER TABLE realms
    ADD COLUMN required_level INT UNSIGNED NOT NULL DEFAULT 1 AFTER name,
    ADD COLUMN multiplier DECIMAL(6,3) NOT NULL DEFAULT 1.000 AFTER required_level;
...
ALTER TABLE users
    ...
    ADD COLUMN breakthrough_attempts INT UNSIGNED NOT NULL DEFAULT 0 AFTER last_breakthrough_at,
    ADD COLUMN active_scroll_type VARCHAR(30) NULL DEFAULT NULL AFTER breakthrough_attempts,
    ADD COLUMN gold BIGINT NOT NULL DEFAULT 0 AFTER active_scroll_type,
    ADD COLUMN spirit_stones BIGINT NOT NULL DEFAULT 0 AFTER gold,
    ADD COLUMN pvp_stamina INT NOT NULL DEFAULT 5 AFTER spirit_stones,
    ADD COLUMN last_stamina_regen DATETIME NULL DEFAULT NULL AFTER pvp_stamina,
    ADD COLUMN last_chat_message_at DATETIME NULL DEFAULT NULL AFTER last_stamina_regen,
    ADD COLUMN last_boss_attack_at DATETIME NULL DEFAULT NULL AFTER last_chat_message_at,
    ADD COLUMN last_sect_war_attack_at DATETIME NULL DEFAULT NULL AFTER last_boss_attack_at;
...
CREATE TABLE IF NOT EXISTS user_location (
    ...
    explore_burst_count TINYINT UNSIGNED NOT NULL DEFAULT 0,
    explore_blocked_until DATETIME NULL DEFAULT NULL,
    FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE,
...
ALTER TABLE users
    ADD COLUMN admin_level VARCHAR(20) NULL DEFAULT NULL AFTER is_admin;
...
ALTER TABLE users
    ADD COLUMN equipped_title_id INT UNSIGNED NULL DEFAULT NULL AFTER last_sect_war_attack_at,
    ADD COLUMN title_pve_wins INT UNSIGNED NOT NULL DEFAULT 0 AFTER equipped_title_id,
    ADD COLUMN title_explore_count INT UNSIGNED NOT NULL DEFAULT 0 AFTER title_pve_wins,
    ADD COLUMN title_boss_attacks INT UNSIGNED NOT NULL DEFAULT 0 AFTER title_explore_count,
    ADD COLUMN title_sect_donated_gold BIGINT UNSIGNED NOT NULL DEFAULT 0 AFTER title_boss_attacks,
    ADD COLUMN title_tribulations_won INT UNSIGNED NOT NULL DEFAULT 0 AFTER title_sect_donated_gold;
...
-- Primary attributes & character build (Laravel migration 2026_05_16_000001)
ALTER TABLE users
    ADD COLUMN IF NOT EXISTS strength SMALLINT UNSIGNED NOT NULL DEFAULT 5,
    ADD COLUMN IF NOT EXISTS agility SMALLINT UNSIGNED NOT NULL DEFAULT 5,
    ADD COLUMN IF NOT EXISTS vitality SMALLINT UNSIGNED NOT NULL DEFAULT 5,
    ADD COLUMN IF NOT EXISTS spirit SMALLINT UNSIGNED NOT NULL DEFAULT 5,
    ADD COLUMN IF NOT EXISTS soul SMALLINT UNSIGNED NOT NULL DEFAULT 5,
    ADD COLUMN IF NOT EXISTS willpower SMALLINT UNSIGNED NOT NULL DEFAULT 5,
    ADD COLUMN IF NOT EXISTS attribute_points SMALLINT UNSIGNED NOT NULL DEFAULT 0,
    ADD COLUMN IF NOT EXISTS stat_specialization VARCHAR(32) NULL,
    ADD COLUMN IF NOT EXISTS body_type VARCHAR(48) NULL,
    ADD COLUMN IF NOT EXISTS attribute_respec_count SMALLINT UNSIGNED NOT NULL DEFAULT 0;
