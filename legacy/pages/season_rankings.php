    ...
    <div class="container mx-auto px-4 py-8 max-w-5xl">
        ...
        <?php if ($season === null): ?>
            <div class="bg-gray-800/80 border border-amber-500/30 rounded-xl p-6 text-gray-300">
                <p class="mb-2">No active season yet. Ensure the DB was initialized with <code class="text-amber-400">database_full.sql</code> and visit again (a default season is created automatically).</p>
            </div>
        <?php else: ?>
